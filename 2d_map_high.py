# sbatch --array=0-499 --mem-per-cpu=256000 --wrap="python 2d_map_high.py"
...
if __name__ == "__main__":
    ...
    out_file = RESULT_TMP / \
        f"macs_volume_lengthscale_N{N}_R{realization_index}.csv"
    df.to_csv(out_file, index=False)

print("time = ", time_module.time() - t)
print('sbatch --array=0-499 --mem-per-cpu=256000 ' +
      '--wrap="python 2d_map_high.py"')
